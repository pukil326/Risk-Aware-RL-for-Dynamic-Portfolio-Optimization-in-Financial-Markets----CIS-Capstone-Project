...
OUTDIR_DEFAULT = "ml_outputs_dqn_13train24test"
...
class DQNAgent:
    def __init__(self, state_size: int, action_size: int = 2):
        ...
        self.lr = 1e-2 # Faster learning rate from paper's best model
...
def run(symbol="AAPL", episodes=50, outdir=OUTDIR_DEFAULT):
    ...
    # Use the new quarterly split function instead of chrono_split

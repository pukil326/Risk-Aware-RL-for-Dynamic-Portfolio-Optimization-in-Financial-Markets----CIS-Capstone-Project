...
OUTDIR_DEFAULT = "ml_outputs_ppo_13train24test"
...
def run(symbol="AAPL", episodes=50, outdir=OUTDIR_DEFAULT):
    print(f">>> Advanced PPO Agent (Quarterly Split)  Py={sys.executable}", flush=True)
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="Advanced PPO Trading Agent with Quarterly Split")

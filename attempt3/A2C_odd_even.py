...
OUTDIR_DEFAULT = "ml_outputs_a2c_monthly"
...
def run(symbol="AAPL", episodes=50, outdir=OUTDIR_DEFAULT):
    print(f">>> Advanced A2C Agent (Monthly Split)  Py={sys.executable}", flush=True)
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="Advanced A2C Trading Agent with Monthly Split")

...
OUTDIR_DEFAULT = "ml_outputs_dqn_monthly"
...
def run(symbol="AAPL", episodes=50, outdir=OUTDIR_DEFAULT):
    print(f">>> Advanced DQN Agent (Monthly Split)  Py={sys.executable}", flush=True)
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="Advanced DQN Trading Agent with Monthly Split")
